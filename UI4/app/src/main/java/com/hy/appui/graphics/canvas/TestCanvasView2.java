...
/**
 * 绘图级的动画，有用户交互
 * http://www.jianshu.com/p/4493f8266d49
 */
public class TestCanvasView2 extends View {
    ...
    private final int BALL_SIZE = 36;
    // 小球纵向的运行速度
    ...
    public TestCanvasView2(Context context,AttributeSet attrs){
        super(context, attrs);
    }
    ...
    public void initListener(TestCanvasView2 mTestCanvasView2){
        mTestCanvasView2.setOnKeyListener(new MyListener());
    }
    private class MyListener implements OnKeyListener {
        @Override
